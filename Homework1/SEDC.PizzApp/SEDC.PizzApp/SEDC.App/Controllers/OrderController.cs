...
namespace SEDC.App.Controllers
{
    public class OrderController : Controller
    {
        ...
        public OrderController()
        {
            ...
            Pizza Kapri = new Pizza() { Id = 10, Name = "KAPRI", Price = 150.50 , Size = 6 };
            Pizza Toskana = new Pizza() { Id = 20, Name = "TOSKANA", Price = 210.70, Size = 8 };
            Pizza Peperoni = new Pizza() { Id = 30, Name = "PEPERONI", Price = 260.20, Size = 8 };
